...
pub fn init_db(conn: &Connection) -> SqliteResult<()> {
    table_creation::create_playlists_table(conn)?;
    table_creation::create_categories_table(conn)?;
    table_creation::create_streams_table(conn)?;
    table_creation::create_epg_data_table(conn)?;
    table_creation::create_vod_metadata_table(conn)?;
    table_creation::create_selected_channel_table(conn)?;
    table_creation::create_channels_table(conn)?;
